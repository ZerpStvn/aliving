...
function theme_enqueue_styles()
{
    ...
    wp_register_style('main_article2_css', aliving_css . '/main_article2.css', array(), '1.4', 'all');
    wp_register_style('main_article_css', aliving_css . '/main_article.css', array(), '1.2', 'all');
