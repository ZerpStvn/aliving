...
function shareicon()
{
    ...
    <div class="shar-bar">
        ...
        <div class="socialicons">
            ...
            <a href="https://instagram.com/share?url=<?php echo urlencode(get_permalink()); ?>" target="_blank"><img
                    src="<?php echo aliving_image . "/icon/social/iconinsta.svg" ?>" alt="twitter" loading="lazy"></a>
