...
{
    // Define categories and panel IDs
    $categories = array('decor', 'house_improvement', 'home_decoration', 'garden'); // Replace with actual category slugs
    ...
    <ul class="tooglepanelwrap">
        ...
        foreach ($categories as $index => $category_slug) {
            // Setup WP_Query for each category
            $query_args = array(
                'post_type' => 'editorial',
                'meta_query' => array(
                    'relation' => 'AND',
