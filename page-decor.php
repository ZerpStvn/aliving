        ...
        <div class="decorwrap global_width">
            <div class="homecollection ">
                <div class="trending">
                    ...
                    <?php trendFront('trending', 'decor') ?>
                    <div class="hottopics">
                        <?php trendFrontHottopics('hot_topic', 'editorial') ?>
                    </div>
                    <div class="featured">
                        <?php trendFrontfeatured('featured', 'editorial', 'decor') ?>
                    </div>
                </div>
                <div class="articles">

                    <div class="featuredarticles">
                        <?php articlefeatured('decor') ?>
                    </div>
                    <div class="list_of_articles">

                        <?php listofarticle('decor') ?>
