<?php get_header() ?>
<div class="gardening collections">
    ...
    <div class="decorwrap global_width">
        <div class="homecollection ">
            <div class="trending">
                ...
                <?php trendFront('trending', 'garden') ?>
                <div class="hottopics">
                    <?php trendFrontHottopics('hot_topic', 'editorial') ?>
                </div>
                <div class="featured">
                    <?php trendFrontfeatured('featured', 'editorial', 'garden') ?>
                </div>
            </div>
            <div class="articles">

                <div class="featuredarticles">
                    <?php articlefeatured('garden', ) ?>
                </div>
